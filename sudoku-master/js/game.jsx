  ...
  render() {
    return (
      <div className="dialog">
        ...
        <button data-difficulty="Beginner" onClick={this.difficultyClick}>Beginner</button>
        <button data-difficulty="Moderate" onClick={this.difficultyClick}>Moderate</button>
        <button data-difficulty="Challenging" onClick={this.difficultyClick}>Challenging</button>
        <button data-difficulty="Difficult" onClick={this.difficultyClick}>Difficult</button>
        <button data-difficulty="Expert" onClick={this.difficultyClick}>Expert</button>
        <button data-difficulty="Extreme" onClick={this.difficultyClick}>Extreme</button>
      </div>
    );
  }
    ...
    return (
      <div className="index">
        ...
        {this.hasExistingGame()
          ? <p><Link to="play">resume the existing one</Link></p>
          : null}
      </div>
    );
  }
